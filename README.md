_Disclaimer: both styling and validation rules applied are very basic, the focus was on having a decent starting point for pure web components that could be expanded with real world requirements as needed._
